...
public class Isolation{
    ...
    public static void main(String args[]) throws Throwable 
    {
        ...
        if(humanwins) {
            JOptionPane.showMessageDialog(null," Congrates You have Won the game");
        }
        else {
            JOptionPane.showMessageDialog(null, "You have Lose the game");
        }
        System.exit(0);
    }
